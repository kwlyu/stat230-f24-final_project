...
happinessBase_aug<-augment(happiness_glm, resid.type="pearson")
  #Commute
happinessBase_aug$CommuteGroups<-ntile(happinessBase_aug$commute, n=20)
happinessBase_aug_resid1<- happinessBase_aug %>%
  ...
  #Education
happinessBase_aug$EducGroups<-ntile(happinessBase_aug$educ, n=20)
happinessBase_aug_resid2<- happinessBase_aug %>%
  group_by(EducGroups) %>%
    summarize(EducGroupsMed = median(educ),
              resid_mean=mean(.resid), resid_med=median(.resid))
  #Income
happinessBase_aug$YGroups<-ntile(happinessBase_aug$realrinc, n=20)
